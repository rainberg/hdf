      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            <div className="mb-2 text-lg font-bold text-brand-600">华德福</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link href="/companies" className="hover:text-brand-600">转运公司</Link></li>
              <li><Link href="/codes" className="hover:text-brand-600">优惠码</Link></li>
              <li><Link href="/phone-plans" className="hover:text-brand-600">电话套餐</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="mb-3 text-sm font-semibold text-gray-900">商家</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link href="/merchant/apply" className="hover:text-brand-600">入驻申请</Link></li>
              <li><Link href="/merchant" className="hover:text-brand-600">商家后台</Link></li>
            </ul>
          </div>
          <div>
